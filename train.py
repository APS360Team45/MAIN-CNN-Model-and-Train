...
paramys = torch.load("model_ripeness_detector_bs64_lr0.001_epoch87")
...
train(model, train_dataset, val_dataset, batch_size=64, print_stat=True, num_epochs=13, current_epoch=87)